...
ffmpeg -y -i face0_CMP_CMPVP907_1M.mp4 -vf "crop=w=in_w/3:h=in_h/2:x=0*(in_w/3):y=0*(in_h/2)" -c:v libx264 -keyint_min 30 -g 30 -sc_threshold 0 -an face0.mp4
ffmpeg -y -i face0_CMP_CMPVP907_1M.mp4 -vf "crop=w=in_w/3:h=in_h/2:x=1*(in_w/3):y=0*(in_h/2)" -c:v libx264 -keyint_min 30 -g 30 -sc_threshold 0 -an face1.mp4
ffmpeg -y -i face0_CMP_CMPVP907_1M.mp4 -vf "crop=w=in_w/3:h=in_h/2:x=2*(in_w/3):y=0*(in_h/2)" -c:v libx264 -keyint_min 30 -g 30 -sc_threshold 0 -an face2.mp4
ffmpeg -y -i face0_CMP_CMPVP907_1M.mp4 -vf "crop=w=in_w/3:h=in_h/2:x=0*(in_w/3):y=1*(in_h/2)" -c:v libx264 -keyint_min 30 -g 30 -sc_threshold 0 -an face3.mp4
ffmpeg -y -i face0_CMP_CMPVP907_1M.mp4 -vf "crop=w=in_w/3:h=in_h/2:x=1*(in_w/3):y=1*(in_h/2)" -c:v libx264 -keyint_min 30 -g 30 -sc_threshold 0 -an face4.mp4
ffmpeg -y -i face0_CMP_CMPVP907_1M.mp4 -vf "crop=w=in_w/3:h=in_h/2:x=2*(in_w/3):y=1*(in_h/2)" -c:v libx264 -keyint_min 30 -g 30 -sc_threshold 0 -an face5.mp4

ffmpeg -i test_0.mp4 -c:v libx264 -crf 40 -b:v 0 -keyint_min 30 -g 30 -sc_threshold 0 -an test_0_40.mp4
ffmpeg -y -i test-50M.mp4 -vf "crop=w=in_w/10:h=in_h/5:x=5*(in_w/10):y=3*(in_h/10)" -c:v libx264 -keyint_min 30 -g 30 -sc_threshold 0 -an test-50M_35.mp4
ffmpeg -y -i test.mp4 -b:v 230000k test-230M.mp4

ffmpeg -i ERP_video.mp4 -vf v360=e:c3x2:cubic:w=5760:h=3840:out_pad=0 -c:v libx264 -crf 0 -b:v 0 -keyint_min 30 -g 30 -sc_threshold 0 -an CMP_video.mp4

ffmpeg -y -i face0.mp4 -vf "crop=w=in_w/3:h=in_h/2:x=0*(in_w/3):y=0*(in_h/3)" -c:v libx264 -keyint_min 30 -g 30 -sc_threshold 0 -an tile0.mp4

  configuration: --enable-gpl --enable-libmp3lame --enable-libopencore-amrnb --enable-libopencore-amrwb --enable-libtheora --enable-libx264 --enable-libxvid --enable-nonfree --enable-postproc --enable-version3 --enable-shared --enable-pic
...
deb [signed-by=/usr/share/keyrings/cuda-archive-keyring.gpg] https://developer.download.nvidia.com/compute/cuda/repos/ubuntu1804/x86_64/ /
